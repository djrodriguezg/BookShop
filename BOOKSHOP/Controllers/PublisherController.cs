...
namespace BOOKSHOP.Controllers
{
    ...
    public class PublisherController : ControllerBase
    {
        ...
        GenericResponse<DTO_PUBLISHER> Response;

        public PublisherController(ILibrary library)
        {
            _library = library;
        }
        // POST api/<PublisherController>
        [HttpPost]
        public IActionResult Post([FromBody] RqPublisher rqPublisher)
        {
            try
            {
                var result = new object();

                result = _library.InsertPublisher(rqPublisher);
                ...
                {
                    Response = new GenericResponse<DTO_PUBLISHER>();
                    Response = (GenericResponse<DTO_PUBLISHER>)result;
                }
